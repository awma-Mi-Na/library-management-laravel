...
Route::get('admin/search-results', [SearchRecordsController::class, 'search'])->middleware('isAdmin');
Route::post('admin/search-results', [SearchRecordsController::class, 'search'])->middleware('isAdmin');
